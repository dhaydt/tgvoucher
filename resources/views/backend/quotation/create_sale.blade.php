...
<script type="text/javascript">
    ...
    $('#subtotal').text(parseFloat($('input[name="total_price"]').val()).toFixed(0));
    ...
    $('#order_discount').text(parseFloat($('input[name="order_discount_value"]').val()).toFixed(0));
    ...
    $('input[name="paid_amount"]').on("input", function() {
        ...
        $("#change").text( parseFloat($("#paying-amount").val() - $(this).val()).toFixed(0) );
        var id = $('select[name="paid_by_id"]').val();
        if(id == 2){
    ...
    $('input[name="paying_amount"]').on("input", function() {
        $("#change").text( parseFloat($(this).val() - $("#paid-amount").val()).toFixed(0));
    });
    ...
    function calculateGrandTotal() {
        ...
        if( $('select[name="payment_status"]').val() == 4 ){
            $('#paying-amount').val('');
            $('#paid-amount').val(grand_total.toFixed(0));
        }
